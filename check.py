            ...
            for part in msg.walk():
                ...
                if filename:
                    ...
                    if filename.endswith(('.xls', '.xlsx')):
                        ...
                        existing_filename = 'new_try.xlsx'
                        try:
                        ...
                        # Copy the first 4 rows from the original sheet
                        for row_idx in range(1, 5):
                            row = sheet[row_idx]
                            for col_idx, cell in enumerate(row, 1):
                                existing_sheet.cell(row=row_idx, column=col_idx).value = cell.value
...
sns.heatmap(df_heatmap.T, cmap=cmap, annot=True, fmt=".1f")  #coolwarm,YlGnBu
